...
import com.example.a10518.memo.Time.MyFormat;
import com.example.a10518.memo.Time.MyTimeGetter;
...
public class EditActivity extends BaseActivity implements View.OnClickListener,
    ...
    boolean saveFunction(String title,String body,String createDate){
        ...
        if(flag){
            ...
            values.put(myDatabase.RECORD_TIME,createDate);
            if (timeSetTag){
                //  为当前备忘录添加提醒
                ...
                values.put(myDatabase.NOTICE_TIME,str);
            }
