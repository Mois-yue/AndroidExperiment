...
public class AmendActivity extends BaseActivity implements View.OnClickListener{
    ...
    void init(){
        ...
        amendTitle = findViewById(R.id.amend);
        amendBody = findViewById(R.id.amend_body);
        amendTime = findViewById(R.id.amend_title_time);

        btnUpcoming = findViewById(R.id.menu_upcoming);
        btnNotice = findViewById(R.id.menu_notice);
        ...
        if (intent!=null){
            ...
            record.setId(Integer.valueOf(intent.getStringExtra(myDatabase.RECORD_ID)));
            record.setTitleName(intent.getStringExtra(myDatabase.RECORD_TITLE));
            record.setTextBody(intent.getStringExtra(myDatabase.RECORD_BODY));
            record.setCreateTime(intent.getStringExtra(myDatabase.RECORD_TIME));
            record.setNoticeTime(intent.getStringExtra(myDatabase.NOTICE_TIME));
    ...
    boolean updateFunction(String body){
        ...
        if(flag){
            ...
            values.put(myDatabase.RECORD_BODY,body);
